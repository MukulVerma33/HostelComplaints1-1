        ...
        complaints_db.insert_one(
                    {
                        ...
                        'complaint_desc' : session['complaint_desc'], 'comments' : None, 'caretaker_id' : None, 'assinee' : None, 'expected_date' : None, 'status_info' : {'status' : 1 , "timestamp" : [datetime.timestamp(datetime.now())]}
                    }
                )
